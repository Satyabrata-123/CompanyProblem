...
public class AiService {
    ...
    public CompareIdeaWithSolutionResponse compareIdeaWithSolution(CompareIdeaWithSolutionRequest request) {
        try {
            ...
            // Build prompt for AI comparison with AI detection
            String prompt = String.format("""
                You are an expert evaluator with two critical tasks:
                
                TASK 1: Compare the user's idea with the company's solution
                TASK 2: Detect if the idea was AI-generated (and penalize accordingly)
                ...
                1. MATCH ANALYSIS:
                   - Compare how well the user's idea aligns with the company's solution
                   - Score from 0-100 (100 = perfect match)
                   - Match levels: EXCELLENT (90-100), GOOD (70-89), PARTIAL (40-69), POOR (0-39)
                
                2. AI DETECTION (CRITICAL):
                   Detect if the idea was AI-generated by looking for:
                   - Overly polished, generic, or template-like language
                   - Perfect grammar with no personal voice or style
                   - Lack of specific examples, personal experience, or unique insights
                   - Generic buzzwords without concrete details
                   - Structured format that looks AI-generated (bullet points, perfect organization)
                   - Absence of informal language, typos, or natural human writing patterns
                   
                   If AI-generated is detected:
                   - Set "aiDetected": true
                   - REDUCE the match score by 40-60 points (severe penalty)
                   - Explain why it appears AI-generated
                   - Note: Even if the content matches well, AI-generated ideas show lack of genuine understanding
                
                3. SCORING RULES:
                   - Original human idea with good match: 70-100 points
                   - Original human idea with partial match: 40-69 points
                   - AI-generated idea (regardless of match): Maximum 30-40 points
                   - AI-generated with poor match: 0-20 points
                
                Respond in this exact JSON format:
                {
                  "matchScore": <number 0-100, REDUCED if AI detected>,
                  "matchLevel": "<EXCELLENT|GOOD|PARTIAL|POOR>",
                  "feedback": "<explanation including AI detection if applicable>",
                  "strengths": "<genuine strengths, or 'Limited - appears AI-generated'>",
                  "improvements": "<areas for improvement, emphasize need for original thinking if AI detected>",
                  "aiDetected": <true|false>,
                  "aiDetectionReason": "<detailed explanation of why AI was detected, or 'No AI detected - appears to be original human work'>"
                }
                
                IMPORTANT: Be strict with AI detection. If there's any doubt, investigate carefully. Genuine human ideas have imperfections, personal touches, and unique perspectives.
                """,
    ...
    private CompareIdeaWithSolutionResponse parseComparisonJson(String text, CompareIdeaWithSolutionRequest request) {
        try {
            ...
            // Extract AI detection fields
            Boolean aiDetected = extractJsonBoolean(text, "aiDetected");
            String aiDetectionReason = extractJsonString(text, "aiDetectionReason");
            ...
            boolean penaltyApplied = aiDetected && matchScore < 70.0;
            ...
            return CompareIdeaWithSolutionResponse.builder()
                    ...
                    .aiDetectionReason(aiDetectionReason != null ? aiDetectionReason : "No AI detection analysis performed")
    ...
    private Boolean extractJsonBoolean(String json, String key) {
        try {
            ...
            System.err.println("Failed to extract boolean for key: " + key);
        }
        return null;
    }
