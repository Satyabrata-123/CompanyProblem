...
export default function SubmitIdeaPage() {
  ...
  // Prevent companies from submitting ideas
  if (currentUser.accountType === 'company' || currentUser.role === 'company') {
    return Layout(`
      <div class="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-8 text-center">
          <div class="text-6xl mb-4">🏢</div>
          <h2 class="text-2xl font-bold text-gray-900 mb-4">Company Account Restriction</h2>
          <p class="text-gray-700 mb-6">
            Companies cannot submit regular ideas. Instead, you can create challenges for employees to solve.
          </p>
          <div class="flex justify-center gap-4">
            <button onclick="window.app.router.navigate('/company/challenges/create')" class="btn-primary">
              Create Challenge
            </button>
            <button onclick="window.app.router.navigate('/company/Dashboard')" class="btn-secondary">
              Go to Dashboard
            </button>
          </div>
        </div>
